...
const actionFieldsAreEqual = (a, b) => {
  ...
  return isEqual(aFields.sort(), bFields.sort());
};
...
const checkPermissionsAreBound = role =>
  function(permissions) {
    ...
    for (const [subject, perms] of Object.entries(permsBySubject)) {
      ...
      const everyActionsHaveSameFields = every(permsBoundByFields, haveSameFieldsAsOtherActions);
